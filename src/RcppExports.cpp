...
#include "../inst/include/RiskScore.h"
#include <RcppEigen.h>
#include <Rcpp.h>
#include <string>
#include <set>
...
RcppExport SEXP _RiskScore_fit_proba(SEXP xSEXP, SEXP ySEXP, SEXP n_iterSEXP, SEXP lrSEXP, SEXP n_quantilesSEXP, SEXP ss_rateSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_RiskScore_fit_proba_try(xSEXP, ySEXP, n_iterSEXP, lrSEXP, n_quantilesSEXP, ss_rateSEXP));
    }
...
RcppExport SEXP _RiskScore_fit(SEXP xSEXP, SEXP ySEXP, SEXP n_iterSEXP, SEXP lrSEXP, SEXP n_quantilesSEXP, SEXP ss_rateSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_RiskScore_fit_try(xSEXP, ySEXP, n_iterSEXP, lrSEXP, n_quantilesSEXP, ss_rateSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
RcppExport SEXP _RiskScore_RcppExport_registerCCallable() { 
    R_RegisterCCallable("RiskScore", "_RiskScore_fit_proba", (DL_FUNC)_RiskScore_fit_proba_try);
    R_RegisterCCallable("RiskScore", "_RiskScore_fit", (DL_FUNC)_RiskScore_fit_try);
    R_RegisterCCallable("RiskScore", "_RiskScore_fit_survival", (DL_FUNC)_RiskScore_fit_survival_try);
    R_RegisterCCallable("RiskScore", "_RiskScore_RcppExport_validate", (DL_FUNC)_RiskScore_RcppExport_validate);
    return R_NilValue;
}
...
RcppExport void R_init_RiskScore(DllInfo *dll) {
